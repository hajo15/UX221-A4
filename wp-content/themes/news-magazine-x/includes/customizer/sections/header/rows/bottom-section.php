...
Kirki::add_field( 'newsx_theme_config', [
    'type' => 'switch',
    'settings' => 'newsx_options[section_hd_bottom_enable]',
...
Kirki::add_field( 'newsx_theme_config', [
    'type'     => 'repeater',
    'settings' => 'newsx_options[section_hd_bottom_elements]',
    ...
    'fields'   => [
        ...
        'hd_bottom_element_duplicate' => newsx_get_pro_field_args( 'header_element_duplicate' ),
    ...
    'row_label' => [
        ...
        'field' => 'hd_bottom_select_element',
    ],
...
Kirki::add_field( 'newsx_theme_config', [
    'type' => 'inputslider',
    'settings' => 'newsx_options[section_hd_bottom_height]',
...
// Add Pro Field
newsx_add_pro_field( 'section_hd_bottom_sticky', 35 );

Kirki::add_field( 'newsx_theme_config', [
    'type' => 'multicheck',
    'settings' => 'newsx_options[section_hd_bottom_visibility]',
...
// Add Pro Fields
newsx_add_pro_field( 'section_hd_bottom_bg', 110 );
newsx_add_pro_field( 'section_hd_bottom_bd_color', 120 );
newsx_add_pro_field( 'section_hd_bottom_bd_width', 130 );

Kirki::add_field( 'newsx_theme_config', [
    'type' => 'newsx-headline',
    'settings' => 'newsx_options[hd_bottom_spacing_headline]',
    'section' => 'newsx_section_hd_bottom',
	'tab' => 'design',
...
Kirki::add_field( 'newsx_theme_config', [
    'type' => 'kirki-margin',
    'settings' => 'newsx_options[hd_bottom_padding]',
    'section' => 'newsx_section_hd_bottom',
	'tab' => 'design',
...
if ( !defined('NEWSX_CORE_PRO_VERSION') || !newsx_core_pro_fs()->can_use_premium_code() ) {
    ...
    Kirki::add_field( 'newsx_theme_config', [
        ...
        'settings' => 'newsx_options[section_hd_bottom_upgrade_pro_list]',
        'section' => 'newsx_section_hd_bottom',
        'tab' => 'general',
        ...
        'description' => 'https://wp-royal-themes.com/themes/item-news-magazine-x-pro/?ref=newsx-free-customizer-header-sec-bottom-upgrade-pro#features',
        'divider' => 'newsx-group-divider-top',
        'priority' => 999,
    ] );
