...
if ( defined('NEWSX_CORE_PRO_VERSION') && newsx_core_pro_fs()->can_use_premium_code() ) :
    newsx_add_pro_controls_group( 'footer-custom-html-1' );
...
Kirki::add_field( 'newsx_theme_config', [
    ...
    'settings' => 'newsx_options[footer_html1_upgrade_pro_list]',
    'section' => 'newsx_section_ft_custom_html_1',
    'tab' => 'general',
    ...
    'description' => 'https://wp-royal-themes.com/themes/item-news-magazine-x-pro/?ref=newsx-free-customizer-footer-sec-custom-html-1-upgrade-pro#features',
    'divider' => 'newsx-group-divider-top',
    'priority' => 999,
] );
