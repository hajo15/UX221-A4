	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['settings'] === $this->args['settings'] ) {
			...
			$args['button_labels'] = wp_parse_args(
				$args['button_labels'],
				[
					'select'       => esc_html__( 'Select image', 'news-magazine-x' ),
					'change'       => esc_html__( 'Change image', 'news-magazine-x' ),
					'default'      => esc_html__( 'Default', 'news-magazine-x' ),
					'remove'       => esc_html__( 'Remove', 'news-magazine-x' ),
					'placeholder'  => esc_html__( 'No image selected', 'news-magazine-x' ),
					'frame_title'  => esc_html__( 'Select image', 'news-magazine-x' ),
					'frame_button' => esc_html__( 'Choose image', 'news-magazine-x' ),
				]
			);
