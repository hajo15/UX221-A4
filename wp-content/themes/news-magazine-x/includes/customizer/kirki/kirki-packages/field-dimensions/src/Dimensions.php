...
class Dimensions extends Field {
	...
	public function init( $args = array() ) {
		...
		$labels = array(
			...
			'font-size'      => esc_html__( 'Font Size', 'news-magazine-x' ),
			'font-weight'    => esc_html__( 'Font Weight', 'news-magazine-x' ),
			'line-height'    => esc_html__( 'Line Height', 'news-magazine-x' ),
			'font-style'     => esc_html__( 'Font Style', 'news-magazine-x' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'news-magazine-x' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'news-magazine-x' ),
			'top'            => esc_html__( 'Top', 'news-magazine-x' ),
			'bottom'         => esc_html__( 'Bottom', 'news-magazine-x' ),
			'left'           => esc_html__( 'Left', 'news-magazine-x' ),
			'right'          => esc_html__( 'Right', 'news-magazine-x' ),
			'center'         => esc_html__( 'Center', 'news-magazine-x' ),
			'size'           => esc_html__( 'Size', 'news-magazine-x' ),
			'spacing'        => esc_html__( 'Spacing', 'news-magazine-x' ),
			'width'          => esc_html__( 'Width', 'news-magazine-x' ),
			'height'         => esc_html__( 'Height', 'news-magazine-x' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'news-magazine-x' ),
		);
