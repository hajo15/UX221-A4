...
class ReactSelect extends Base {
	...
	public function to_json() {
		...
		$this->json['placeholder'] = ( $this->placeholder ) ? $this->placeholder : esc_html__( 'Select...', 'news-magazine-x' );
		...
		$this->json['messages'] = [
			...
			'maxLimitReached' => sprintf( esc_html__( 'You can only select %s items', 'news-magazine-x' ), $this->max_selection_number ),
		];
