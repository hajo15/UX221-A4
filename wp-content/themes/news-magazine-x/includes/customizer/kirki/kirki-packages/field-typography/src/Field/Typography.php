...
class Typography extends Field {
	...
	public function init( $args = [] ) {
		...
		self::$std_variants = [
			[
				'value' => 'regular',
				'label' => __( 'Regular', 'news-magazine-x' ),
			],
			[
				'value' => 'italic',
				'label' => __( 'Italic', 'news-magazine-x' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'news-magazine-x' ),
			],
			[
				'value' => '700italic',
				'label' => __( '700 Italic', 'news-magazine-x' ),
			],
		];
		...
		self::$complete_variants = [
			...
			[
				'value' => '100',
				'label' => __( '100', 'news-magazine-x' ),
			],
			[
				'value' => '100italic',
				'label' => __( '100 Italic', 'news-magazine-x' ),
			],
			[
				'value' => '200',
				'label' => __( '200', 'news-magazine-x' ),
			],
			[
				'value' => '200italic',
				'label' => __( '200 Italic', 'news-magazine-x' ),
			],
			[
				'value' => '300',
				'label' => __( '300', 'news-magazine-x' ),
			],
			[
				'value' => '300italic',
				'label' => __( '300 Italic', 'news-magazine-x' ),
			],
			[
				'value' => '500',
				'label' => __( '500', 'news-magazine-x' ),
			],
			[
				'value' => '500italic',
				'label' => __( '500 Italic', 'news-magazine-x' ),
			],
			[
				'value' => '600',
				'label' => __( '600', 'news-magazine-x' ),
			],
			[
				'value' => '600italic',
				'label' => __( '600 Italic', 'news-magazine-x' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'news-magazine-x' ),
			...
			[
				'value' => '800',
				'label' => __( '800', 'news-magazine-x' ),
			],
			[
				'value' => '800italic',
				'label' => __( '800 Italic', 'news-magazine-x' ),
			],
			[
				'value' => '900',
				'label' => __( '900', 'news-magazine-x' ),
			],
			[
				'value' => '900italic',
				'label' => __( '900 Italic', 'news-magazine-x' ),
			],
		];
	...
	private function add_sub_fields( $args ) {
		...
		new \Kirki\Field\Generic(
			wp_parse_args(
				[
					...
					'custom_class' => 'newsx-typography-generic',
				],
				$args
			)
		);
		...
		new \Kirki\Field\Custom(
			wp_parse_args(
				[
					'settings'    => $args['settings'] . '[typography-trigger]',
					'label' 	  => $args['label'],
					// 'default'     => 'color|'. $default_bg_color,
					'section'     => $args['section'],
					'custom_class' => 'newsx-typography-group-trigger',
		...
		if ( isset( $args['default']['font-family'] ) ) {
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Family', 'news-magazine-x' ),
						'description' => '',
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Variant', 'news-magazine-x' ),
						'description' => '',
		...
		if ( $font_size_field_specified ) {
			$group = [
				...
				// 'color'     => [
				// 	'type'         => 'react-colorful',
				// 	'label'        => esc_html__( 'Font Color', 'news-magazine-x' ),
		...
		if ( $text_align_field_specified || $text_transform_field_specified ) {
			$group = [
				'text-align'     => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Align', 'news-magazine-x' ),
					'is_specified' => $text_align_field_specified,
					'choices'      => [
						'initial' => esc_html__( 'Initial', 'news-magazine-x' ),
						'left'    => esc_html__( 'Left', 'news-magazine-x' ),
						'center'  => esc_html__( 'Center', 'news-magazine-x' ),
						'right'   => esc_html__( 'Right', 'news-magazine-x' ),
						'justify' => esc_html__( 'Justify', 'news-magazine-x' ),
					],
				],
				'text-transform' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Transform', 'news-magazine-x' ),
					'is_specified' => $text_transform_field_specified,
					'choices'      => [
						'none'       => esc_html__( 'None', 'news-magazine-x' ),
						'capitalize' => esc_html__( 'Capitalize', 'news-magazine-x' ),
						'uppercase'  => esc_html__( 'Uppercase', 'news-magazine-x' ),
						'lowercase'  => esc_html__( 'Lowercase', 'news-magazine-x' ),
					],
				],
			];
		...
		if ( $text_decoration_field_specified ) {
			$group = [
				'text-decoration' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Decoration', 'news-magazine-x' ),
					'is_specified' => $text_decoration_field_specified,
					'choices'      => [
						'none'         => esc_html__( 'None', 'news-magazine-x' ),
						'underline'    => esc_html__( 'Underline', 'news-magazine-x' ),
						'line-through' => esc_html__( 'Line Through', 'news-magazine-x' ),
						'overline'     => esc_html__( 'Overline', 'news-magazine-x' ),
						'solid'        => esc_html__( 'Solid', 'news-magazine-x' ),
						'wavy'         => esc_html__( 'Wavy', 'news-magazine-x' ),
					],
				],
			];
		...
		if ( $line_height_field_specified || $letter_spacing_field_specified ) {
			$group = [
				'line-height'    => [
					'type'         => 'number',
					'label'        => esc_html__( 'Line Height', 'news-magazine-x' ),
				...
				'letter-spacing' => [
					'type'         => 'number',
					'label'        => esc_html__( 'Letter Spacing', 'news-magazine-x' ),
		...
		if ( $margin_top_field_specified || $margin_bottom_field_specified ) {
			$group = [
				'margin-top'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Top', 'news-magazine-x' ),
					'is_specified' => $margin_top_field_specified,
				],
				'margin-bottom' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Bottom', 'news-magazine-x' ),
	...
	public function generate_controls_group( $group, $args ) {
		...
		foreach ( $group as $css_prop => $control ) {
			if ( $control['is_specified'] ) {
				...
				// by Duke: Fix Classname
				if ( 'Inputslider' === $control_class ) {
					$control_class = '\\Kirki\\Pro\\Field\\InputSlider';
				} else {
	...
	public static function sanitize( $value ) {
		...
		foreach ( $value as $key => $val ) {
			switch ( $key ) {
				...
				case 'font-size':
					$value['font-size'] = array_map('sanitize_text_field', $value['font-size']);
	...
	private function get_font_family_choices() {
		...
		$choices['default'] = [
			esc_html__( 'Defaults', 'news-magazine-x' ),
			[
				'' => esc_html__( 'Default', 'news-magazine-x' ),
			],
		];
		...
		$choices['standard'] = [
			esc_html__( 'Standard Fonts', 'news-magazine-x' ),
			$std_fonts,
		];

		$choices['google'] = [
			esc_html__( 'Google Fonts', 'news-magazine-x' ),
