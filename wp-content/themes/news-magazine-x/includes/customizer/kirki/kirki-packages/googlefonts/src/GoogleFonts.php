...
final class GoogleFonts {
	...
	public function print_googlefonts_json( $die = true ) {
		if ( defined('NEWSX_CORE_PRO_VERSION') && newsx_core_pro_fs()->can_use_premium_code() ) {
			include NEWSX_CORE_PRO_PATH . 'admin/customizer/kirki/googlefonts/webfonts.json'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude
		} else {
	...
	public function get_names_array() {
		ob_start();
		if ( defined('NEWSX_CORE_PRO_VERSION') && newsx_core_pro_fs()->can_use_premium_code() ) {
			include NEWSX_CORE_PRO_PATH . 'admin/customizer/kirki/googlefonts/webfont-names.json'; // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude
		} else {
