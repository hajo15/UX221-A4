...
class SetupSettings {
	...
	public function submenu_page() {
		...
		add_submenu_page(
			'options-general.php',
			__( 'Kirki Customizer Framework', 'news-magazine-x' ),
			__( 'Kirki', 'news-magazine-x' ),
	...
	public function clear_font_cache() {
		...
		if ( is_dir( $fonts_dir ) ) {
			...
			wp_send_json_error( 'No local fonts found.', 'news-magazine-x' );
		}

		wp_send_json_success( 'Font cache cleared.', 'news-magazine-x' );
