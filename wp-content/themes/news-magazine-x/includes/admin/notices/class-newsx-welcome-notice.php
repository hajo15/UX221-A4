			...
			<div class="newsx-message__content">
				<div class="newsx-message__text">
					...
					<div class="newsx-message__cta">
						...
						<a class="newsx-btn-demo-preview button button-primary button-hero" href="https://news-magazine-x-free.wp-royal-themes.com/demo/?ref=newsx-free-dash-welcome-banner-demo-preview" target="_blank">
