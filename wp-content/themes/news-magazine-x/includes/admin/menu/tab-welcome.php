...
<div class="newsx-welcome-hero-section">
    ...
    <div class="newsx-theme-intro">
        ...
        <div class="newsx-action-buttons">
            <a href="https://news-magazine-x-free.wp-royal-themes.com/demo/?ref=newsx-free-dash-welcome-demo-preview" class="button button-primary newsx-demo-preview-link" target="_blank">
...
<div class="newsx-sidebar-widget newsx-sidebar-widget-starter-templates">
    ...
    <p>
        <a href="<?php echo esc_url(admin_url('admin.php?page=newsx-options&tab=starter-templates')); ?>">
            <img src="<?php echo esc_url(NEWSX_ADMIN_URL . '/assets/images/starter-templates.jpg'); ?>" alt="<?php esc_attr_e('Starter Templates', 'news-magazine-x'); ?>">
        </a>
    </p>
