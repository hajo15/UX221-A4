...
function newsx_get_dynamic_css() {	
	...
	if ( newsx_get_option('global_image_hover_effects') ) {
		$parse_css .= newsx_minify_static_css('
			/* Zoom */
...
function newsx_get_dark_mode_css() {
	return newsx_minify_static_css('
		/* Background Color */
		...
		/* Heading Color */
		.newsx-site-title-tagline .site-title a, h1, h1 a, h2, h2 a, h3, h3 a, h4, h4 a, h5, h5 a, h6, h6 a, .newsx-grid-title > :where(div, p, span) a,
