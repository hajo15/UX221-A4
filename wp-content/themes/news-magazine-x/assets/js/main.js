jQuery( document ).ready( function( $ ) {
    ...
    var NewsxGridAjaxPosts = {
        ...
        fetchPosts: function( pageNumber, eventTarget ) {
            ...
            let pageCache = JSON.parse(localStorage.getItem(self.pageCacheKey)) || {};
            ...
            var cacheKey = pageNumber + activeFilter + targetGrid.data('id');
            ...
            if ( pageCache[cacheKey] ) {
                targetGrid.html(pageCache[cacheKey]);
            ...
            // Fetch new content
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        localStorage.setItem(self.pageCacheKey, JSON.stringify(pageCache));
                    },
                    error: function () {
                        console.error('Failed to fetch posts.');
                    }
